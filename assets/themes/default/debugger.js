...
var tests = {
  ...
  "test-2":"assets/themes/default/test2.xml",
  "test-3":"test/rokubunnoichi.xml",
  "test-4":"test/mikunoshoushitsu.xml",
  "test-5":"test/unowen.xml",
  "test-6":"test/comment.xml",
  "test-7":"assets/themes/default/extended.xml",
  "test-8":"assets/themes/default/boss.xml",
...
function bindTests(){
  ...
  $('test-ins').addEventListener("click", function() {
    var comment = {
      "mode":1,
